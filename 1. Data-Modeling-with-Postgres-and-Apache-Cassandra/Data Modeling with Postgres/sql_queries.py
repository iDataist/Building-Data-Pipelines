...
# duration float?
song_table_create = "CREATE TABLE IF NOT EXISTS songs (song_id varchar NOT NULL PRIMARY KEY, title varchar, artist_id varchar, year int, duration float);"

# lattitude float, longitude float?
artist_table_create = "CREATE TABLE IF NOT EXISTS artists (artist_id varchar NOT NULL PRIMARY KEY, name varchar, location varchar, lattitude float, longitude float);"
